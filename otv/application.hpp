...
#ifndef PULSEVIEW_OTV_APPLICATION_HPP
#define PULSEVIEW_OTV_APPLICATION_HPP
...
class Application : public QApplication, public otv::GlobalSettingsInterface
{
	Q_OBJECT
...
public:
	...
	void collect_version_info(otv::DeviceManager &device_manager);
...
#endif // PULSEVIEW_OTV_APPLICATION_HPP
