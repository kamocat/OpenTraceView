...
#ifndef PULSEVIEW_OTV_DIALOGS_CONNECT_HPP
#define PULSEVIEW_OTV_DIALOGS_CONNECT_HPP
...
Q_DECLARE_METATYPE(shared_ptr<opentrace::Driver>);
Q_DECLARE_METATYPE(shared_ptr<otv::devices::HardwareDevice>);
...
public:
	Connect(QWidget *parent, otv::DeviceManager &device_manager);
...
private:
	...
	void populate_serials(shared_ptr<opentrace::Driver> driver);
...
private:
	otv::DeviceManager &device_manager_;
...
#endif // PULSEVIEW_OTV_DIALOGS_CONNECT_HPP
