...
#ifndef PULSEVIEW_OTV_DIALOGS_INPUTOUTPUTOPTIONS_HPP
#define PULSEVIEW_OTV_DIALOGS_INPUTOUTPUTOPTIONS_HPP
...
public:
	...
	InputOutputOptions(const QString &title,
		const map<string, shared_ptr<opentrace::Option>> &options,
		QWidget *parent);
...
private:
	...
	otv::binding::InputOutput binding_;
};

} // namespace dialogs
} // namespace otv

#endif // PULSEVIEW_OTV_DIALOGS_INPUTOUTPUTOPTIONS_HPP
