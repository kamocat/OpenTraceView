...
#ifndef PULSEVIEW_OTV_BINDING_DEVICE_HPP
#define PULSEVIEW_OTV_BINDING_DEVICE_HPP
...
public:
	Device(shared_ptr<opentrace::Configurable> configurable);
...
private:
	...
	void bind_enum(const QString &name, const QString &desc,
		const opentrace::ConfigKey *key,
		set<const opentrace::Capability *> capabilities,
		prop::Property::Getter getter, prop::Property::Setter setter,
...
protected:
	shared_ptr<opentrace::Configurable> configurable_;
};

}  // namespace binding
}  // namespace otv

#endif // PULSEVIEW_OTV_BINDING_DEVICE_HPP
