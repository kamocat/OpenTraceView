...
#ifndef PULSEVIEW_OTV_DATA_SIGNALBASE_HPP
#define PULSEVIEW_OTV_DATA_SIGNALBASE_HPP
...
public:
	SignalBase(shared_ptr<opentrace::Channel> channel, ChannelType channel_type);
	virtual ~SignalBase();
...
public:
	 ...
	 */
	void set_data(shared_ptr<otv::data::SignalData> data);
...
protected:
	shared_ptr<opentrace::Channel> channel_;
	ChannelType channel_type_;
	SignalGroup* group_;
	shared_ptr<otv::data::SignalData> data_;
	shared_ptr<otv::data::SignalData> converted_data_;
...
Q_DECLARE_METATYPE(shared_ptr<otv::data::SignalBase>);

#endif // PULSEVIEW_OTV_DATA_SIGNALBASE_HPP
