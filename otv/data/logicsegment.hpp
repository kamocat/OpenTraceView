...
#ifndef PULSEVIEW_OTV_DATA_LOGICSEGMENT_HPP
#define PULSEVIEW_OTV_DATA_LOGICSEGMENT_HPP
...
public:
	LogicSegment(otv::data::Logic& owner, uint32_t segment_id,
	...
	void append_payload(shared_ptr<opentrace::Logic> logic);
...
#endif // PULSEVIEW_OTV_DATA_LOGICSEGMENT_HPP
